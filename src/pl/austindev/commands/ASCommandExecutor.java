...
public abstract class ASCommandExecutor extends ACommandExecutor<AShops> {
	...
	public ASCommandExecutor(AShops plugin, ASCommand aCommand) {
		super(plugin, aCommand, ASMessage.NO_PERMISSION, ASMessage.NOT_PLAYER);
		this.shopsManager = plugin.getShopsManager();
	}

	protected ShopsManager getShopsManager() {
		return shopsManager;
	}
}
